...
export class Renderer {
  ...
  constructor(gl: WebGLRenderingContext) {
    ...
    this.heightAttributeLocation = this.gl.getAttribLocation(this.program, 'aHeight');
  ...
  render(frequencyData: Uint8Array): void {
    ...
    this.gl.bufferData(this.gl.ARRAY_BUFFER, new Float32Array(heights), this.gl.DYNAMIC_DRAW);
    this.gl.vertexAttribPointer(this.heightAttributeLocation, 1, this.gl.FLOAT, false, 0, 0);
